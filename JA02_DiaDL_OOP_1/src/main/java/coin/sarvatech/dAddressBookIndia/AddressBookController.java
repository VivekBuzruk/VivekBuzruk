...
public class AddressBookController
{
    ...
    { 
    	...
    	String[] fieldNames = gui.getAddressBook().getAddressEntryFields();
        ...
        if (information != null)
        {
     		if (gui.getAddressBook().getPersonInformation(
    					Person.fullName(information[0], information[1])) != null)
    			gui.reportError("A person of that name is already in the list");
			else        
				gui.getAddressBook().addPerson(information[0],
											   information[1], 
											   information[2],
											   information[3],
											   information[4],
    ...
    public void doEdit(String name)
    {
        ...
        String [] fieldNames = gui.getAddressBook().getModifiableAddressEntryFields(); // "Address", "City", "State", "Pincode", "Phone", "Email" };
    ...
    /** Do the Sort Entries by Pincode Use Case
     */
    public void doSortByPincode()
    {
        gui.getAddressBook().sortByPincode(); 
    }
    ...
    *
    */
   public boolean doExportAs() throws IOException
   { 
       JFileChooser chooser = new JFileChooser(System.getProperty("user.dir"));
       ...
       {
           File saveTo = chooser.getSelectedFile();
           fileSystem.saveCSVFile(gui.getAddressBook().getAddressEntryFields(), 
        		                      gui.getAddressBook().getAddressEntriesIterator(), saveTo);
           return true;
       }
       else
           return false;
    ...
    { 
        ...
        switch (answer)
        {
            ...
            case JOptionPane.YES_OPTION:
                ...
                {
                    gui.reportError("Problem writing the file: " + e.getMessage());
                    return DONT_PROCEED;
                }
