...
public class AddressBookGUI extends JFrame implements Observer
{
    ...
    private JMenuItem newItem, openItem, saveItem, saveAsItem, exportAsItem;
    private JMenuItem printMailingLabelsItem, quitItem;
    private JMenuItem sortByNameItem, sortByPincodeItem;
    ...
    public AddressBookGUI(final AddressBookController controller)
    {
        ...
        exportAsItem.setAccelerator(keystroke(KeyEvent.VK_E, InputEvent.SHIFT_MASK));
        ...
        sortByPincodeItem = new JMenuItem("Sort by Pincode");
        sortMenu.add(sortByPincodeItem);
        ...
        sortByPincodeItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            { 
                controller.doSortByPincode();
            }
        });
